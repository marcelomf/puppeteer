...
describe('Cookie specs', () => {
    ...
    describe('Page.cookies', function () {
        ...
        it('should properly report httpOnly cookie', async () => {
            ...
            (0, expect_1.default)(cookies).toHaveLength(1);
            (0, expect_1.default)(cookies[0].httpOnly).toBe(true);
        });
        it('should properly report "Strict" sameSite cookie', async () => {
            ...
            const cookies = await page.cookies();
            (0, expect_1.default)(cookies).toHaveLength(1);
            (0, expect_1.default)(cookies[0].sameSite).toBe('Strict');
        });
        it('should properly report "Lax" sameSite cookie', async () => {
            ...
            const cookies = await page.cookies();
            (0, expect_1.default)(cookies).toHaveLength(1);
            (0, expect_1.default)(cookies[0].sameSite).toBe('Lax');
        });
        it('should get multiple cookies', async () => {
            ...
            await (0, mocha_utils_js_1.expectCookieEquals)(cookies, [
                {
                    name: 'password',
                    value: '1234',
                    domain: 'localhost',
        ...
        it('should not get cookies from subdomain', async () => {
            ...
            (0, expect_1.default)(cookies).toHaveLength(0);
        });
        it('should get cookies from nested path', async () => {
            ...
            const cookies = await page.cookies('https://foo.com/some_path/nested_path');
            (0, expect_1.default)(cookies).toHaveLength(1);
        });
        it('should not get cookies from not nested path', async () => {
            ...
            const cookies = await page.cookies('https://foo.com/some_path_looks_like_nested');
            (0, expect_1.default)(cookies).toHaveLength(0);
        });
    });
    describe('Page.setCookie', function () {
        ...
        it('should isolate cookies in browser contexts', async () => {
            const { page, server, browser } = await (0, mocha_utils_js_1.getTestState)();
            ...
            try {
                ...
                (0, expect_1.default)(cookies1).toHaveLength(1);
                (0, expect_1.default)(cookies2).toHaveLength(1);
                (0, expect_1.default)(cookies1[0].name).toBe('page1cookie');
                (0, expect_1.default)(cookies1[0].value).toBe('page1value');
                (0, expect_1.default)(cookies2[0].name).toBe('page2cookie');
                (0, expect_1.default)(cookies2[0].value).toBe('page2value');
            }
            finally {
        ...
        it('should set multiple cookies', async () => {
            ...
            (0, expect_1.default)(cookieStrings).toEqual(['foo=bar', 'password=123456']);
        });
        it('should have |expires| set to |-1| for session cookies', async () => {
            ...
            const cookies = await page.cookies();
            (0, expect_1.default)(cookies[0].session).toBe(true);
            (0, expect_1.default)(cookies[0].expires).toBe(-1);
        });
        it('should set cookie with reasonable defaults', async () => {
            ...
            const cookies = await page.cookies();
            await (0, mocha_utils_js_1.expectCookieEquals)(cookies.sort((a, b) => {
                return a.name.localeCompare(b.name);
            }), [
                {
                    name: 'password',
        ...
        it('should set a cookie with a path', async () => {
            ...
            (0, expect_1.default)(await page.evaluate('document.cookie')).toBe('gridcookie=GRID');
            await page.goto(server.EMPTY_PAGE);
            await (0, mocha_utils_js_1.expectCookieEquals)(await page.cookies(), []);
            (0, expect_1.default)(await page.evaluate('document.cookie')).toBe('');
            await page.goto(server.PREFIX + '/grid.html');
            (0, expect_1.default)(await page.evaluate('document.cookie')).toBe('gridcookie=GRID');
        });
        it('should not set a cookie on a blank page', async () => {
            ...
            (0, expect_1.default)(error.message).toContain('At least one of the url and domain needs to be specified');
        });
        it('should not set a cookie with blank page URL', async () => {
            ...
            (0, expect_1.default)(error.message).toEqual(`Blank page can not have cookie "example-cookie-blank"`);
        });
        ...
        it('should default to setting secure cookie for HTTPS websites', async () => {
            ...
            (0, expect_1.default)(cookie.secure).toBe(true);
        });
        it('should be able to set insecure cookie for HTTP website', async () => {
            ...
            (0, expect_1.default)(cookie.secure).toBe(false);
        });
        it('should set a cookie on a different domain', async () => {
            ...
            (0, expect_1.default)(await page.evaluate('document.cookie')).toBe('');
            await (0, mocha_utils_js_1.expectCookieEquals)(await page.cookies(), []);
            await (0, mocha_utils_js_1.expectCookieEquals)(await page.cookies('https://www.example.com'), [
                {
                    name: 'example-cookie',
                    value: 'best',
        ...
        it('should set cookies from a frame', async () => {
            ...
            (0, expect_1.default)(await page.evaluate('document.cookie')).toBe('localhost-cookie=best');
            (0, expect_1.default)(await page.frames()[1].evaluate('document.cookie')).toBe('');
            await (0, mocha_utils_js_1.expectCookieEquals)(await page.cookies(), [
                {
            ...
            await (0, mocha_utils_js_1.expectCookieEquals)(await page.cookies(server.CROSS_PROCESS_PREFIX), [
                {
                    name: '127-cookie',
                    value: 'worst',
                    domain: '127.0.0.1',
        ...
        it('should set secure same-site cookies from a frame', async () => {
            const { httpsServer, browser, close } = await (0, mocha_utils_js_1.launch)({
            ...
            try {
                ...
                (0, expect_1.default)(await page.frames()[1].evaluate('document.cookie')).toBe('127-same-site-cookie=best');
                await (0, mocha_utils_js_1.expectCookieEquals)(await page.cookies(httpsServer.CROSS_PROCESS_PREFIX), [
                    {
                        name: '127-same-site-cookie',
                        value: 'best',
                        domain: '127.0.0.1',
    ...
    describe('Page.deleteCookie', function () {
        it('should delete cookie', async () => {
            ...
            (0, expect_1.default)(await page.evaluate('document.cookie')).toBe('cookie1=1; cookie2=2; cookie3=3');
            await page.deleteCookie({ name: 'cookie2' });
            (0, expect_1.default)(await page.evaluate('document.cookie')).toBe('cookie1=1; cookie3=3');
        });
        it('should not delete cookie for different domain', async () => {
            ...
            (0, expect_1.default)(await page.cookies()).toHaveLength(1);
            ...
            (0, expect_1.default)(await page.cookies(COOKIE_DESTINATION_URL)).toHaveLength(1);
            await page.deleteCookie({ name: COOKIE_NAME });
            // Verify the cookie is deleted for the current page.
            (0, expect_1.default)(await page.cookies()).toHaveLength(0);
            // Verify the cookie is not deleted for different domain.
            await (0, mocha_utils_js_1.expectCookieEquals)(await page.cookies(COOKIE_DESTINATION_URL), [
                {
                    name: COOKIE_NAME,
                    value: 'COOKIE_DESTINATION_URL cookie value',
                    domain: 'example.com',
        ...
        it('should delete cookie for specified URL', async () => {
            ...
            (0, expect_1.default)(await page.cookies(COOKIE_DESTINATION_URL)).toHaveLength(0);
