...
describe('`puppeteer` with Webpack', () => {
    ...
    it('evaluates WebPack Bundles', async function () {
        ...
        await writeFile(join(this.sandbox, 'webpack.config.mjs'), await readAsset('puppeteer', 'webpack', 'webpack.config.js'));
        // Write the source code.
        await writeFile(join(this.sandbox, 'index.js'), await readAsset('puppeteer', 'basic.js'));
        // Bundle.
...
//# sourceMappingURL=puppeteer-webpack.spec.js.map