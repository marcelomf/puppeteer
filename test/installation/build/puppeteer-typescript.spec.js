...
(platform() === 'win32' ? describe.skip : describe)('`puppeteer` with TypeScript', () => {
    configureSandbox({
    ...
    it('should work', async function () {
        ...
        await writeFile(join(this.sandbox, 'tsconfig.json'), await readAsset('puppeteer', 'tsconfig.json'));
        // Write the source code.
        await writeFile(join(this.sandbox, 'index.ts'), await readAsset('puppeteer', 'basic.ts'));
        // Compile.
...
//# sourceMappingURL=puppeteer-typescript.spec.js.map