...
(platform() === 'win32' ? describe.skip : describe)('`puppeteer` with Firefox', () => {
    configureSandbox({
...
describe('Firefox download', () => {
    ...
    it('can download Firefox stable', async function () {
        ...
        const result = spawnSync('npx', ['puppeteer', 'browsers', 'install', 'firefox@stable'], {
...
//# sourceMappingURL=puppeteer-firefox.spec.js.map